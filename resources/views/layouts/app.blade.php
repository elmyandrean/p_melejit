...
<head>
  ...
  <title>@yield('title') | Monitoring Referal E-Jitu</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset("images/logo.png")}}" width="50%" alt=""></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{asset("images/logo_mandiri.png")}}" width="40%" alt="" style="margin-top: -10px;"></span>
    </a>
