...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="{{route('transaction.index')}}"><i class="fa fa-dashboard"></i> Transaction</a></li>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">New Data Transaction</h3>
      </div>
      <div class="box-body">
        <form action="{{route('transaction.store')}}" method="POST" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <select name="product_holding" id="product-holding" class="form-control" onchange="changeProduct(this.value);">
                ...
                <option value="Mandiri Internet Bisnis">Mandiri Internet Bisnis</option>
                <option value="Mandiri Cash Management">Mandiri Cash Management</option>
              </select>
            </div>
          </div>
          <div class="form-group">
          ...
          <hr>
          <div id="merchant" style="display: block">
            <div class="form-group">
              <label for="nama_merchant" class="control-label col-md-2">Nama Merchant</label>
              <div class="col-md-6">
                <input type="number" class="form-control" name="nama_merchant" id="nama-merchant">
              </div>
            </div>
          </div>
          <div id="nasabah" style="display:none;">
            <div class="form-group">
              <label for="nama_nasabah" class="control-label col-md-2">Nama Nasabah</label>
              <div class="col-md-6">
                <input type="number" class="form-control" name="nama_nasabah" id="nama_nasabah">
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" class="form-control" name="no_rekening" id="no-rekening">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-offset-2 col-md-6">
              <button class="btn btn-primary">Simpan</button>
              <a href="{{route('transaction.index')}}" class="btn btn-warning">Batal</a>
            </div>
          </div>
        </form>
      </div>
