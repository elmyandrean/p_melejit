      ...
      <tr>
        ...
        <td class="text-center">
          <form action="{{route('users.destroy', $user->id)}}" method="POST">
            ...
            <button type="button" class="btn btn-warning btn-xs"  onclick="modalEdit('{{$user->id}}')" title="Edit User"><i class="fa fa-edit"></i></button>
            <button type="submit" class="btn btn-danger btn-xs delete-button" onclick="delteUser('{{$user->id}}', this)" title="Delete User" data-userid="{{$user->id}}"><i class="fa fa-trash"></i></button>
          </form>
        </td>
      </tr>
      @endforeach
